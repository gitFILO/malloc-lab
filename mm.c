...
#define SEGREGATED_SIZE (18) // 가용 리스트 개수
...
#define CLASS_SIZES {16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072,262144,524288,1048576}


int class_sizes[SEGREGATED_SIZE] = CLASS_SIZES;
int mm_init(void)
{
    // 초기 힙 생성
